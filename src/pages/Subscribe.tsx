      ...
      <main className="flex flex-col items-center justify-center py-24 px-6">
        <div className="max-w-lg w-full">
          ...
          <p className="text-muted-foreground font-body text-base leading-relaxed mb-8">
            Every morning, AI reads hundreds of posts about the autonomous revolution and writes you one sharp, story-driven briefing on what machines are doing in business, finance, and society.
          </p>
